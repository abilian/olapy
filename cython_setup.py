...
extensions = [
    ...
    pypyx_ext(NAME, "core", "services", "schema_response"),
    pypyx_ext(NAME, "core", "services", "utils"),
    pypyx_ext(NAME, "core", "services", "xmla_discover_schema_rowsets_response_items"),
    ...
    pypyx_ext(NAME, "core", "services", "discover_properties_items"),
    pypyx_ext(NAME, "core", "services", "xmla_discover_fill_xml"),
    ...
    pypyx_ext(NAME, "core", "services", "xmla_discover_properties_xml"),
