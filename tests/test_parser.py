...
from olapy.core.parse import decorticate_query, MdxParser
...
def test_parsing_query1():
    query_parts = decorticate_query(query1)
...
def test_parsing_query2():
    query_parts = decorticate_query(query2)
...
def test_parsing_query3():
    query_parts = decorticate_query(query3)
    assert query_parts["all"] == [
...
def test_parsing_query4():
    query_parts = decorticate_query(query4)
    assert query_parts["all"] == [
        ["geography", "economy", "partnership"],
        ["geography", "geo", "country"],
    ]
...
def test_parsing_query5():
    query_parts = decorticate_query(query5)
    assert query_parts["all"] == [
...
def test_parsing_query6():
    ...
    query_parts = decorticate_query(query6)
    assert query_parts["all"] == [
        ["time", "time", "year"],
        ["time", "time", "year", "2010"],
