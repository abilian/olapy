...
ALTER TABLE facts OWNER TO postgres;
...
ALTER TABLE geography OWNER TO postgres;
...
COPY facts (day, city, licence, amount, count) FROM stdin;
...
COPY geography (continent, country, city) FROM stdin;
...
COPY product (company, article, licence) FROM stdin;
...
COPY "time" (year, quarter, month, day) FROM stdin;
